...
Next, install minikube. Note that this step assumes a Linux OS and an
...
Run a test prompt against the chat completions API.
#+begin_src shell
...
#+begin_src shell
  # Scale down model size, GPU nodes, etc.
...
#+BEGIN_SRC python :prologue "source .venv/bin/activate" :results file graphics :exports results :file eval_ai/workflow_llm_d.png :eval yes
#+END_SRC

#+RESULTS:
[[file:eval_ai/workflow_llm_d.png]]
