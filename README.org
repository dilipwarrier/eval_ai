...
For vllm, the standard "pip install -r requirements.txt" method doesn't work.

This is because vllm requires different modules depending upon whether it is running on a CPU or a GPU.
