...
#+begin_src shell
  ...
  # Scale down the default GPU requirements
  helmfile -f helmfile.yaml.gotmpl apply -n llm-d \
  --set ms-inference-scheduling.replicaCount=1 \
  --set ms-inference-scheduling.vllm.tensorParallelSize=1 \
  --set ms-inference-scheduling.resources.limits."nvidia\.com/gpu"=1 \
  --set ms-inference-scheduling.resources.requests."nvidia\.com/gpu"=1 \
  --set ms-inference-scheduling.resources.requests.cpu=4 \
  --set ms-inference-scheduling.resources.requests.memory=16Gi
#+end_src
